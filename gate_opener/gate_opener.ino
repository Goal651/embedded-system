...
const int closedAngle = 7;
const int openAngle = 105;
const unsigned long closeDelay = 4000;  // 4 seconds before closing
...
bool buzzerOn = false;
const unsigned long beepOnTime = 40;  // 40ms ON
const unsigned long beepCycle = 400;  // Total cycle: 400ms
